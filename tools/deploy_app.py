...
# [boot-ms] prints are launch-timing milestones: time.ticks_ms() counts from
# power-on. They split the Python phase into VM-boot (first line), the
# seedsigner.controller import chain, and Controller construction; the
# OpeningSplash logo-slide fires inside start().
import sys
import time
